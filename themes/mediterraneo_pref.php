...
$webcal_theme = array (
  'MENU_THEME'   => 'mediterraneo',
  'BGCOLOR'      => '#CED3DC',  // Document background
  'CELLBG'       => '#AED2ED',  // Table cell background
  'H2COLOR'      => '#000000',  // Document title
  'HASEVENTSBG'  => '#9AC7E9',  // Table cell background for days with events
  'MYEVENTS'     => '#000000',  // My events text
  'OTHERMONTHBG' => '#FCF7F8',  // Table cell background for other month
  ...
  'THBG'         => '#4E8098',  // Table header background
  'THFG'         => '#CEDCC2',  // Table header text
  'TODAYCELLBG'  => '#7EA2B4',  // Table cell background for current day
  'WEEKENDBG'    => '#C2DDF1',  // Table cell background for weekends
 );
